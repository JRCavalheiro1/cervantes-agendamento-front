...
export default function ListaProfissionais() {
    ...
    return (
       <ListaContainer titulo={translationListaProf('title')} subtitulo={translationListaProf('subtitle')} className="min-w-[352px] xl:flex-1">
           ...
           {modalAberto && profissionalSelecionado && (
               <ModalProfissional profissional={profissionalSelecionado} onClose={fechaModal} open={modalAberto}/>
           )}
       </ListaContainer>
